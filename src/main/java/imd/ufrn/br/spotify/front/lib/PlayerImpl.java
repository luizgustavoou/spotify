...
import imd.ufrn.br.spotify.front.utils.ICallback;
...
public class PlayerImpl implements Player {
    ...
    public PlayerImpl() {}
    public PlayerImpl(ICallback beginTimer, ICallback cancelTimer) {
        this.beginTimer = beginTimer;
        this.cancelTimer = cancelTimer;
    }
    private ICallback beginTimer;
    private ICallback cancelTimer;
